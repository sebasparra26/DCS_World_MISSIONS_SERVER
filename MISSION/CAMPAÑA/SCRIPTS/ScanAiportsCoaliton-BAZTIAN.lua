...
local aeropuertos = {
    ...
    ["Al-Bateen"] = { position = {x = -190948, y = 0, z = -181927}, radius = 2000},                             --3-- Metric: X-00190948 Z-00181927    Medium
    ...
    ["Bandar Lengeh"] = { position = {x = 41538, y = 0, z = -140953}, radius = 5000 },                          --21-- Metric: X+00041538 Z-00140953   Small
    ...
    ["Bandar Abbas intl"] = { position = {x = 115847, y = 0, z = 14156}, radius = 8000 },                       --26- Metric: X+00115847 Z+00014156   Medium
