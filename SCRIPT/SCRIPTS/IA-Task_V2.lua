...
--
-- NUEVO:
--   - CAS ahora busca un grupo terrestre enemigo dentro del radio
--     y le asigna AttackGroup cuando entra al sector.
--   - Si el clon ya voló por encima de 10 AGL y luego se queda a
--     velocidad casi 0 durante 30 segundos, desaparece.
----------------------------------------------------------------
