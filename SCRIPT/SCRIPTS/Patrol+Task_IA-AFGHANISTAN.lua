...
local PATROL_DEFINITIONS = {
    ...
    {
        name = "PATRULLA_BULGARIA",
        templates = { "Patrol_IA_BULGARIA_1", "Patrol_IA_BULGARIA_2", "Patrol_IA_BULGARIA_3", "Patrol_IA_BULGARIA_4" },
        clonePrefix = "BULGARIA air ",
        activationFlag = nil,
        activationValue = nil, -- 0 = NEUTRAL, 1 = ROJO, 2 = AZUL
