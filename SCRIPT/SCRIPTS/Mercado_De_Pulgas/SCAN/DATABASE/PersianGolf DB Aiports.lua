...
aeropuertos = {
    ...
    ["Khasab"] = { position = {x = -152, y = 0, z = -164}, radius = 12000},                                     --13-- Metric: X-00000152 Z-00000164   Medium
    ["Bandar-e-Jask"] = { position = {x = -57219, y = 0, z = 156064}, radius = 12000 },                          --14-- Metric: X-00057219 Z+00156064   Medium
    ["Sir Abu Nuayr"] = { position = {x = -103098, y = 0, z = -202998}, radius = 12000 },                        --16-- Metric: X-00103098 Z-00202998   Small
    ["Abu Musa Island"] = { position = {x = -31498, y = 0, z = -121336}, radius = 12000 },                       --17-- Metric: X-00031498 Z-00121336   Small
    ["Sirri Island"] = { position = {x = -26948, y = 0, z = -170744}, radius = 12000 },                          --18-- Metric: X-00026948 Z-00170744   Small
    ...
    ["Kish Intl"] = { position = {x = 42782, y = 0, z = -225092}, radius = 12000 },                              --22-- Metric: X+00042782 Z-00225092   Medium
