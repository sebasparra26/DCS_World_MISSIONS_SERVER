...
HDEV_LoadQueue = HDEV_LoadQueue or {
    -- Persistance System
   { file = "PERSISTANCESYSTEM\\SystemUnitPositionPersistence.lua",              enabled = true,  required = true,  delay = 0 },
   { file = "PERSISTANCESYSTEM\\SistemAirbasePersistanceSinai.lua",              enabled = true,  required = true,  delay = 0 },
   { file = "PERSISTANCESYSTEM\\SystemWarehousesPersistanceSinai.lua",              enabled = true,  required = true,  delay = 0 },
