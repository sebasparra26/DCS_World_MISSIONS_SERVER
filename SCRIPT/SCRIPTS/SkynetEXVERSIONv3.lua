...
-- RED: Command Center
local ccRED = StaticObject.getByName('RED-COMMAND-CENTER')
redIADS:addCommandCenter(ccRED)
...
-- BLUE: Command Center
local ccBLUE = StaticObject.getByName('BLUE-COMMAND-CENTER')
blueIADS:addCommandCenter(ccBLUE)
