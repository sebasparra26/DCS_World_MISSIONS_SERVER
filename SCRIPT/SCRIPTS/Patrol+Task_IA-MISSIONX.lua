...
-- ========================================
do
    local nombre = "PATRULLA_RUSSIA_HEL"
    local templates = { "Patrol_IA_HEL_RUSSIA_1", "Patrol_IA_HEL_RUSSIA_2"}
...
-- ========================================
do
    local nombre = "PATRULLA_SYRIA_HEL"
    local templates = { "Patrol_IA_HEL_SYRIA_1", "Patrol_IA_HEL_SYRIA_2"}
    local prefijo = "SYRIA hel "
    local rangoDeteccion = 80 * 1852
    local rangoEnganche = 60 * 1852
    local debugMensajes = false
...
-- ========================================
do
    local nombre = "PATRULLA_SYRIA_AIR"
    local templates = { "Patrol_IA_AIR_SYRIA_1", "Patrol_IA_AIR_SYRIA_2", "Patrol_IA_AIR_SYRIA_3", "Patrol_IA_AIR_SYRIA_4" }
...
do
    ...
    local templates = { "Patrol_IA_AIR_RUSSIA_1", "Patrol_IA_AIR_RUSSIA_2", "Patrol_IA_AIR_RUSSIA_3"}
