...
local spawnStart = 11    -- Número de inicio del grupo (por ejemplo, 1 para TGT_01)
...
local spawnZone = "REDFOR"  -- Zona donde se realizará el spawn
...
local drawColor = {0, 0, 255}  -- Color en formato RGB (verde en este caso)
...
local drawName = "REDFOR"  -- Nombre para el draw
