...
-- ========================================
do
    local nombre = "PATRULLA_IRAN_AIR 01"
    local templates = { "Patrol_IA_IRAN_1", "Patrol_IA_IRAN_2", "Patrol_IA_IRAN_3" }
...
-- ========================================
do
    local nombre = "PATRULLA_SERBIA_AIR 01"
    local templates = { "Patrol_IA_SERBIA_1", "Patrol_IA_SERBIA_2", "Patrol_IA_SERBIA_3" }
    local prefijo = "SERBIA air "
    local rangoDeteccion = 70 * 1852
    local rangoEnganche = 55 * 1852
    local debugMensajes = false
