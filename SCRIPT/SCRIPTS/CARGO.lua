...
-- - Tipo de carga random (con nombre amigable)
...
local CFG = {
  ...
  --===========================================================
  -- label: nombre amigable que ve el jugador
...
--=============================================================
-- Loop de verificacion por mision
--=============================================================
...
local function missionStatus()
  ...
  -- Ordenar IDs para que el texto salga consistente
  local ids = {}
