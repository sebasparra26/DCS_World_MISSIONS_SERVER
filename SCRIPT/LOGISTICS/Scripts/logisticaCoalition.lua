-- ========================================
-- SISTEMA LOGÍSTICO FUNCIONALIDAD (AZUL)
-- Archivo original funcional suministrado por Sebastián
-- ========================================

-- Puntos iniciales de cada coalición
puntosCoalicion = { PuntosAZUL = 50, PuntosROJO = 0 }

-- Control de cooldowns por tipo de avión y destino
menuCooldowns = menuCooldowns or {}

-- Registro de entregas activas (grupos en vuelo hacia destino)
activeDeliveries = activeDeliveries or {}

-- Tipos de aviones definidos con su inventario (esto se define en otro script antes)
tipoAviones = tipoAviones or {}

-- Raíz del menú (no usado directamente acá, pero inicializado)
menuRoot = nil

-- Lista de nombres posibles que MIST puede asignar a los grupos clonados
nombresPosibles = {}
for i = 1, 9999 do
    table.insert(nombresPosibles, "USA air " .. i)
end

-- Tiempo de espera (cooldown) entre entregas por aeropuerto
local cooldownTiempo = 600  -- en segundos

-- Tabla que asocia cada aeropuerto con su plantilla y bandera
...
-- Recargo al costo base por aeropuerto
...
-- Multiplicador para estimar tiempo de entrega (en base a la distancia)
...
-- Coordenadas de destino por aeropuerto
...
-- ================================
-- FUNCIÓN: Cargar inventario al llegar
-- ================================
...
-- ================================
-- FUNCIÓN: Ejecutar entrega logística
-- ================================
...
-- ================================
-- FUNCIÓN: Verifica aterrizaje de los grupos activos
-- ================================
