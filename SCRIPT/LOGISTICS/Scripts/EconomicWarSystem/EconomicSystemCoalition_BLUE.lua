...
local zonaDeteccion = 'EconomicZoneUK'
...
local zonaDeteccion = 'EconomicZoneUK'  -- Nombre de la zona de detección en el ME
...
mist.scheduleFunction(verificarPuntos, {}, timer.getTime() + 10, 300) -- los puntos se generan cada 5 minutos (300 Segundos)