...
-- Configuración
local intervaloMonitoreo = 20              -- Cada cuántos segundos mostrar (pantalla)
...
puntosCoalicion.PuntosAZUL = puntosCoalicion.PuntosAZUL or 500000
puntosCoalicion.PuntosROJO = puntosCoalicion.PuntosROJO or 500000
